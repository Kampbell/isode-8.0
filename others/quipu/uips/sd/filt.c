...
#ifndef lint
static char *rcsid = "$Header: /xtel/isode/isode/others/quipu/uips/sd/RCS/filt.c,v 9.0 1992/06/16 12:45:08 isode Rel $";
#endif
...
filt_struct *filt;
{
	...
	case ITEM:
		...
		case SUBSTRING:
			...
			if ((av = str2AttrV(svalue, sfilt->
								flt_un.flt_un_item.fi_un.fi_un_substrings.fi_sub_type->
								oa_syntax)) == NULLAttrV) {
				rfilt = sfilt->flt_next;
				sfilt->flt_next = NULLFILTER;
				filter_free(sfilt);
