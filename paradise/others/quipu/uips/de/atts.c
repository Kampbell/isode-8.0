...
#ifndef	lint
static char *rcsid = "$Header: /xtel/isode/isode/others/quipu/uips/de/RCS/atts.c,v 9.1 1992/08/25 15:50:26 isode Exp $";
#endif

/*
 * $Header: /xtel/isode/isode/others/quipu/uips/de/RCS/atts.c,v 9.1 1992/08/25 15:50:26 isode Exp $
 *
 *
 * $Log: atts.c,v $
...
struct namelist * lp;
{
	...
	for (at = lp->ats; at != NULLATTR; at = at->attr_link) {
		if (strcmp(attr2name(at->attr_type, OIDPART), DE_OBJECT_CLASS) == 0)
			continue; /* we don't print object classes */
		switch (objectType) {
		case PERSON:
			(void) strcpy(padding, "        ");
			break;
