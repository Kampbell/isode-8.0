...
#ifndef	lint
static char *rcsid = "$Header: /xtel/isode/isode/others/quipu/uips/de/RCS/dehelp.c,v 9.1 1992/08/25 15:50:26 isode Exp $";
#endif

/*
 * $Header: /xtel/isode/isode/others/quipu/uips/de/RCS/dehelp.c,v 9.1 1992/08/25 15:50:26 isode Exp $
 *
 *
 * $Log: dehelp.c,v $
...
tailorHelp() {
	...
	if (controlCtoQuit)
		for (i = 0; helpTopics[i].unique != 0; i++) {
			...
			if (strcmp(helpTopics[i].topic, "commands") == 0)
				helpTopics[i].fullname = "commandscc";
		}
}
