...
static struct {
	...
	"orginfo", NULLCP, 4,
	"person", "name", 2,
	"personalTitle", NULLCP, 1,
	"postalAddress", NULLCP, 1,
	"problems", NULLCP, 2,
	"rfc822Mailbox", NULLCP, 1,
	"role", NULLCP, 1,
	"roomNumber", NULLCP, 1,
	"settings", NULLCP, 2,
	"screen", NULLCP, 2,
	"surname", NULLCP, 1,
	"telephoneNumber", NULLCP, 1,
	"fax", "facsimileTelephoneNumber", 1,
	"termtypes", NULLCP, 1,
	"welcome", NULLCP, 2,
	"wildcards", NULLCP, 2,
	NULLCP, NULLCP, 0
