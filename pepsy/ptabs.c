...
#ifndef	lint
static char *rcsid = "$Header: /xtel/isode/isode/pepsy/RCS/ptabs.c,v 9.0 1992/06/16 12:24:03 isode Rel $";
#endif

/*
 * $Header: /xtel/isode/isode/pepsy/RCS/ptabs.c,v 9.0 1992/06/16 12:24:03 isode Rel $
 *
 *
 * $Log: ptabs.c,v $
...
char   *type;
{
	...
	if (yp->yp_bef_alist && yp->yp_bef_alist->yal_prn)
		gen_act(fp, yp->yp_bef_alist->yal_prn, yp);
	...
	if (yp->yp_yfn && yp->yp_yfn->yfn_prt) {
		...
		if (yp->yp_aft_alist && yp->yp_aft_alist->yal_prn)
			gen_act(fp, yp->yp_aft_alist->yal_prn, yp);
